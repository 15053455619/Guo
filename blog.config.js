...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Programmer Guo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '爱打球的码农🏀', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lameloball.top', // 网站地址
