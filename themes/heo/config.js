const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://lameloball.top' },
    { title: '访问我的电子简历', url: 'https://baidu.com' }
  ],
  ...
  HERO_TITLE_4: '我的Vue',
  HERO_TITLE_5: 'vite的小理解',
  HERO_TITLE_LINK: 'https://tangly1024.com',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '我的文章', url: '/tag/one' },
  HERO_CATEGORY_2: { title: '项目问题', url: '/tag/two' },
  HERO_CATEGORY_3: { title: '实用教程', url: '/tag/three' },
